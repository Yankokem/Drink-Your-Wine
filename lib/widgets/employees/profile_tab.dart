...
class _ProfileTabState extends State<ProfileTab> {
  ...
  Color getStatusColor() {
    final status = widget.employeeData['status']?.toLowerCase() ?? 'active';
                    ...
                    Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              widget.employeeData['first_name'][0]
                                      .toUpperCase() +
                                  widget.employeeData['last_name'][0]
                                      .toUpperCase(),
                              style: TextStyle(
                                fontSize: 60,
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: _InfoRow(
                                  label: 'First Name',
                                  value: widget.employeeData['first_name'] ??
                                      'N/A',
                              ...
                              Expanded(
                                child: _InfoRow(
                                  label: 'Last Name',
                                  value:
                                      widget.employeeData['last_name'] ?? 'N/A',
                                  icon: Icons.person_outline,
                                ),
                              ),
                            ],
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _InfoRow(
                            label: 'Username',
                            value:
                                '@${widget.employeeData['username'] ?? 'N/A'}',
