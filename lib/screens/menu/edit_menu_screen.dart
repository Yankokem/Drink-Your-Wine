...
class EditMenuScreen extends StatefulWidget {
  ...
  const EditMenuScreen({super.key, this.menuData});
...
class _EditMenuScreenState extends State<EditMenuScreen> {
  ...
  void initState() {
    ...
    _selectedItems = List<Map<String, dynamic>>.from(menu['items'] ?? []);
  }
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: Column(
              children: [
                const PageHeader(title: 'Edit Menu'),
                Expanded(
                  child: Container(
